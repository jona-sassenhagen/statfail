...
In the context of baseline differences between treatment and control groups in clinical trials, a similar debate has been waged (e.g., Senn 1994).
...
Notably, randomization checks have been repeatedly shown to fail at identifying covariates that should be included into multiple regression models (Imai, King & Stuart 2008).
However, the clinical trial literature can support experimental design choices e.g. by discussing the proper way of blocking and matching (ibid).

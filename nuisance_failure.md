...
abstract: |
    ...
    Similarly, when presenting word stimuli, factors such as word frequency are often correlated with primary variables of interest.
...
A prevalent method we find in the literature, namely inferential testing of stimuli, fails to perform the necessary control.
...
The underlying intuition is that these tests establish whether two conditions differ in a given parameter and serve as proof that the conditions are "equal" on that parameter.
...
This is readily implemented via multiple regression, particularly "mixed-effect" approaches [@gelman.hill:2006;@fox:2016].
...
Philosophically, this is somewhat less misguided, but has also been determined to be pragmatically pointless.
...
In total, 86 articles were found where researchers reported known quantities in their stimulus/materials section, and 58 (**67%**) of these reported inferential statistics of these known values.
